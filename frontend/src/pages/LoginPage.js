    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 to-purple-100 p-4">
      <div className="bg-white shadow-2xl rounded-xl p-8 sm:p-10 w-full max-w-md border-t-8 border-pink-500 transform transition duration-500 hover:shadow-pink-300/50">
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <p className="text-gray-500 mt-1">Sign in to continue your virtual walk.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-indigo-600 text-white font-bold p-4 rounded-lg hover:bg-indigo-700 transition duration-300 shadow-md shadow-indigo-300 hover:shadow-lg"
          >
            Login
          </button>
        </form>
