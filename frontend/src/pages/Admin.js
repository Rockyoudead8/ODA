...
function Admin() {
  ...
  if (!userData) {
    return <div className="text-center mt-10 text-gray-700">Loading user data...</div>;
  }

  // Define consistent theme colors for charts
  const primaryIndigo = "rgba(99, 102, 241, 1)"; // Indigo-500
  const secondaryPink = "rgba(236, 72, 153, 1)"; // Pink-500
  const tertiaryTeal = "rgba(20, 184, 166, 1)"; // Teal-500
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-100 p-8 text-gray-800">
      <h1 className="text-4xl font-extrabold mb-8 text-indigo-800 tracking-tight">User Dashboard</h1>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        
        {/* User Info (Left Column) */}
        <div className="col-span-1 bg-white p-8 rounded-2xl shadow-xl border border-gray-200">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-200">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="flex flex-col items-center justify-center p-6 bg-pink-50 rounded-xl shadow-inner w-full md:w-1/3 min-h-[150px]">
                ...
                <span className="text-lg font-medium text-pink-800 mt-2">Unique Cities Explored</span>
              </div>
